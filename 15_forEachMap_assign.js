...
mapEmployees.set(55, emp_rushi);
mapEmployees.set(66, emp_sonali);
mapEmployees.set(77, emp_monika);
mapEmployees.set(88, emp_viny);
mapEmployees.set(99, emp_mahi);

console.log("********* Traverse using forEach() loop *********");
mapEmployees.forEach((key, value) => {
    console.log(`${value} ==> Name: ${key.emp_name}, Dept: ${key.emp_dept}, Salary: ${key.emp_salary}, Company: ${key.emp_company}`);
});
